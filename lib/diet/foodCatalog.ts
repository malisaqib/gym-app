...
export const FOOD_CATALOG: CatalogFood[] = [
  // ---- desi proteins ----
  { id: "eggs2", name: "2 eggs (boiled/fried)", region: "desi", portion: "2 eggs", calories: 160, protein: 12, carbs: 2, fat: 11, vegetarian: true, role: "protein", slots: [B, S], tags: ["egg"], maxAmount: 4 },
  ...
  { id: "chicken_salan", name: "Chicken salan", region: "desi", portion: "1 serving (~200g)", calories: 300, protein: 28, carbs: 8, fat: 18, vegetarian: false, role: "protein", slots: [L, D], tags: ["chicken"], maxAmount: 300 },
  ...
  // ---- desi carbs ----
  { id: "roti2", name: "2 roti", region: "desi", portion: "2 medium", calories: 220, protein: 6, carbs: 44, fat: 4, vegetarian: true, role: "carb", slots: [B, L, D], tags: ["bread"], maxAmount: 4 },
  { id: "roti1", name: "1 roti", region: "desi", portion: "1 medium", calories: 110, protein: 3, carbs: 22, fat: 2, vegetarian: true, role: "carb", slots: [B, L, D], tags: ["bread"], maxAmount: 4 },
  { id: "rice", name: "Boiled rice", region: "desi", portion: "1 katori (~150g)", calories: 200, protein: 4, carbs: 44, fat: 1, vegetarian: true, role: "carb", slots: [L, D], tags: ["rice"], maxAmount: 300 },
  ...
  // ---- desi dairy / drinks ----
  { id: "dahi", name: "Dahi (yogurt)", region: "desi", portion: "1 katori (~150g)", calories: 90, protein: 5, carbs: 8, fat: 4, vegetarian: true, role: "dairy", slots: [B, L, D, S], tags: ["dairy"], maxAmount: 300 },
  ...
  // ---- western proteins ----
  { id: "chicken_breast", name: "Grilled chicken breast", region: "western", portion: "100g", calories: 165, protein: 31, carbs: 0, fat: 4, vegetarian: false, role: "protein", slots: [L, D], tags: ["chicken"], maxAmount: 250 },
